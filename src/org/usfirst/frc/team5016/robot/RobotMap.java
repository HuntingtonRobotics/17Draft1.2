...
public class RobotMap {
	...
	public static final double shooterMinRate = .5; //The motor rate in which motor will slow power slightly
	
	//Encoders\\
	public static final int frontLeftEncoderA = 0, frontLeftEncoderB = 1;
	public static final int frontRightEncoderA = 2, frontRightEncoderB = 3;
	public static final int backLeftEncoderA = 4, backLeftEncoderB = 5;
	public static final int backRightEncoderA = 6, backRightEncoderB = 7;
	public static final int shooterEncoderChannelA = 0, shooterEncoderChannelB = 1;
	public static final double encoderToInches = 0;	
